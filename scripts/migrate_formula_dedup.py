...
CREATE TABLE IF NOT EXISTS evidence (
    ...
    relation_type       TEXT    NOT NULL CHECK (relation_type IN ('source_record','field_value','entity_relation','textual','merged_from','normalized_from')),
    ...
    extraction_method   TEXT    NOT NULL DEFAULT 'manual' CHECK (extraction_method IN ('manual','regex','llm_assisted','migration','etl','normalization')),
